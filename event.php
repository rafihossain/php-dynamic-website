...
?>
    <div class="slider-area">
        <div class="pages-title">
            <div class="single-slider slider-height slider-height-breadcrumb d-flex align-items-center" style="background-image: url(img/bg/blog4.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="events-wrapper events-wrapper-padding">
                                <div class="events-inner d-flex">
                                    <div class="events-thumb">
                                        <a href="event_details.html"><img width="197px" height="240px" src="admin/upload/<?= $event ['event_image'];?>" alt=""></a>
                                    </div>
