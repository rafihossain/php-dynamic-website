                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="header-contact-info d-flex">
                                <div class="header-contact header-contact-phone">
                                    ...
                                    <p class="phone-number">01770-105856</p>
                                </div>
                                <div class="header-contact header-contact-email">
                                    <span class="ti-email"></span>
                                    <p class="email-name">arrafi245@gmail.com</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-2 col-md-6 col-6">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="img/logo/rafi-e-02.png" alt="">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu f-right">
                                <nav id="mobile-menu" style="display: block;">
                                    <ul>
                                        ...
                                        <li <?php if($page=='course.php'){ echo 'class="active"';} ?>><a href="course.php">Course</a></li>
                                        <li <?php if($page=='event.php'){ echo 'class="active"';} ?>><a href="event.php">Event</a></li>
